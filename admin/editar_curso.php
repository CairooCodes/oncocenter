...
if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
  $id = $_GET['edit_id'];
  $stmt_edit = $DB_con->prepare('SELECT * FROM products WHERE id =:uid');
    ...
    <div class="px-6 pt-6 2xl:container">
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="space-y-6">
          ...
          <input value="<?php echo $link ?>" name="link" class="w-full text-sm px-4 py-3 focus:bg-gray-100 border border-gray-300 rounded-none focus:outline-none focus:border-color1" type="" placeholder="Link do Curso">
          ...
          <div class="items-center lg:grid lg:grid-cols-2">
            <img class="h-42" src="./uploads/products/<?php echo $img; ?>" onerror="this.src='../assets/img/semperfil.png'" alt="Profile">
