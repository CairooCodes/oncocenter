...
if (isset($_POST['btnsave'])) {
  ...
  if (empty($name)) {
    $errMSG = "Por favor, insira o nome do Serviço";
  }
  if ($imgFile) {
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="grid w-full justify-center">
          <div class="space-y-6 w-full">
            ...
            <div class="flex justify-center"><img class="h-72 " src="./uploads/services/<?php echo $img; ?>" onerror="this.src='../assets/img/semperfil.png'" alt="Profile"></div>
