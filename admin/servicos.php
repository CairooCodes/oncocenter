      ...
      <div class="pt-4 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        ?>
          <div class="md:col-span-2 lg:col-span-1">
            ...
            <img class="w-full h-72 rounded-md" src="./uploads/services/<?php echo $img ?>" onerror="this.src='../assets/img/semperfil.png'" />
            <a href="editar_servico.php?edit_id=<?php echo $row['id']; ?>">
