      ...
      <div class="pt-4 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        ?>
          <div class="md:col-span-2 grid justify-items-center lg:col-span-1">
            ...
            <img class="w-48 h-60 rounded-md" src="./uploads/books/<?php echo $img ?>" onerror="this.src='../assets/img/semperfil.png'" />
            <div>
              <a href="editar_livro.php?edit_id=<?php echo $row['id']; ?>">
                <button class="text-white px-3 py-2 rounded-md my-2 bg-color1">
                  editar
                </button>
              </a>
