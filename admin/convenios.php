...
if (isset($_GET['delete_id'])) {
  $stmt_delete = $DB_con->prepare('DELETE FROM agreements WHERE id =:uid');
  ...
  <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    ...
    <div class="px-6 pt-6 2xl:container">
      ...
      <div class="pt-4 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <?php
        $stmt = $DB_con->prepare("SELECT * FROM agreements order by id desc");
        $stmt->execute();
        ...
        ?>
          <div class="md:col-span-2 grid justify-items-center lg:col-span-1">
            ...
            <img style="object-fit: cover;" class="w-48 h-48 rounded-md" src="./uploads/agreements/<?php echo $img ?>" onerror="this.src='../assets/img/semperfil.png'" />
            <div>
              <a href="editar_convenio.php?edit_id=<?php echo $row['id']; ?>">
